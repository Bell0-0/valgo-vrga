...
function animarLinea() {
  ...
  // Animar hacia la derecha en negro
  linea.style.transition = 'width 6s linear, background-color 6s linear';
  linea.style.width = '100%';
  linea.style.backgroundColor = 'black';

  // Después de 2 segundos, animar hacia la izquierda en rojo
  setTimeout(() => {
    linea.style.transition = 'width 5s linear, background-color 5s linear';
    linea.style.width = '100';
